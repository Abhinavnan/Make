...
const Home = () => {
    const names = ['YouTube', 'useRef Test','useReducer Test', 'Upload Image', 'MultiSelect in Search', 
                   'GSAP Animation', 'Three JS'];   
    const links = ['/youtube','/useref','/usereducer','/imageupload', '/multiselect', '/gsap', '/threejs']
    ...
    return(
        <AnimatePage>
            <Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100vw',
                ...
                <Box sx={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(5rem,  max-content))', 
                        gap: 2, maxWidth: '100%'}}>
